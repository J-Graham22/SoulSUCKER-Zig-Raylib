...
pub fn LoadPlayerParty() [*]battleModels.BattleUnit {
    ...
    const aMove: battleModels.Move = battleModels.Move{
        .name = "the wham bam attack",
        .stat = battleModels.Stat.Attack,
        .value = 30,
    };

    const moves: [6]battleModels.Move = [6]battleModels.Move{
        aMove,
        aMove,
        aMove,
        aMove,
    ...
    const unit1: battleModels.BattleUnit = battleModels.BattleUnit{
        .name = "player1",
        .level = 5,
        .currentHealth = 20,
        .maxHealth = 30,
        .currentAttack = 10,
        .baseAttack = 10,
        .currentMagicAttack = 15,
        .baseMagicAttack = 15,
        .currentDefense = 12,
        .baseDefense = 12,
        .currentMagicDefense = 8,
        .baseMagicDefense = 8,
        .currentSpeed = 30,
        .baseSpeed = 30,
        .moves = moves,
